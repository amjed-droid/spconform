...
If you encounter an unexpected error, incorrect result, or crash, please
follow these steps.
...
2.  Search the [existing
    issues](https://github.com/amjed-droid/spconform/issues) to see if
...
For usage questions, please open a thread in **GitHub Discussions** if
